...
To run the xfstests suite, use Docker Compose:
...
This command will:
1. Build a Docker image containing the Wormhole binaries, xfstests suite, and all necessary dependencies
2. Start a container with the required privileges (SYS_ADMIN capability and FUSE device access)
3. Execute the test suite automatically
