...
pub mod test {
    ...
    #[allow(unused)]
    use crate::pods::filesystem::permissions::{READ_BIT_FLAG, WRITE_BIT_FLAG, EXECUTE_BIT_FLAG, has_read_perm, has_write_perm, has_execute_perm};

    #[test]
    fn test_r_bit() {
        assert!(has_read_perm(WINDOWS_DEFAULT_PERMS_MODE), "WINDOWS_DEFAULT_PERMS_MODE is read");
        ...
        #[test]
    fn test_w_bit() {
        assert!(has_write_perm(WINDOWS_DEFAULT_PERMS_MODE), "WINDOWS_DEFAULT_PERMS_MODE is write");
        ...
        #[test]
    fn test_x_bit() {
        assert!(!has_execute_perm(WINDOWS_DEFAULT_PERMS_MODE), "WINDOWS_DEFAULT_PERMS_MODE is not exec");
        assert!(has_execute_perm(WRITE_BIT_FLAG), "WRITE_BIT_FLAG is correct");
